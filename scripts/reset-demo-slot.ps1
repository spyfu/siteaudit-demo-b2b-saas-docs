...
$expectedRepository = 'spyfu/siteaudit-demo-b2b-saas-docs'
$expectedRemoteHttps = 'https://github.com/spyfu/siteaudit-demo-b2b-saas-docs.git'
$expectedRemoteSsh = 'git@github.com:spyfu/siteaudit-demo-b2b-saas-docs.git'
