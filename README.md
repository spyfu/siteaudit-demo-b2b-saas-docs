...
| --- | --- | --- | --- |
| `demo-01` | `siteaudit-demo-b2b-saas-docs` | https://siteaudit-demo-b2b-saas-docs.pages.dev/ | https://github.com/spyfu/siteaudit-demo-b2b-saas-docs/edit/demo-01/siteaudit-head.html |
| `demo-02` | `siteaudit-demo-b2b-saas-docs-02` | https://siteaudit-demo-b2b-saas-docs-02.pages.dev/ | https://github.com/spyfu/siteaudit-demo-b2b-saas-docs/edit/demo-02/siteaudit-head.html |
| `demo-03` | `siteaudit-demo-b2b-saas-docs-03` | https://siteaudit-demo-b2b-saas-docs-03.pages.dev/ | https://github.com/spyfu/siteaudit-demo-b2b-saas-docs/edit/demo-03/siteaudit-head.html |
| `demo-04` | `siteaudit-demo-b2b-saas-docs-04` | https://siteaudit-demo-b2b-saas-docs-04.pages.dev/ | https://github.com/spyfu/siteaudit-demo-b2b-saas-docs/edit/demo-04/siteaudit-head.html |
| `demo-05` | `siteaudit-demo-b2b-saas-docs-05` | https://siteaudit-demo-b2b-saas-docs-05.pages.dev/ | https://github.com/spyfu/siteaudit-demo-b2b-saas-docs/edit/demo-05/siteaudit-head.html |
...
```powershell
git clone https://github.com/spyfu/siteaudit-demo-b2b-saas-docs.git
Set-Location siteaudit-demo-b2b-saas-docs
